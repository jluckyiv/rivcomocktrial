	...
	<div class="mx-auto max-w-lg px-4 py-16">
		<Card.Root>
			<Card.Header>
				...
				<Card.Description>
					There is no tournament currently accepting registrations. Please check back later
					or contact RCOE at
...
<div class="mx-auto max-w-lg px-4 py-16">
	<Card.Root>
		<Card.Header>
			...
			<Card.Description>
				Register your team for {data.tournament.name}. RCOE will review your registration
						...
						<Select.Content class="max-h-72">
							<div class="px-2 pb-1 pt-1">
								<input
									...
									class="border-input bg-background placeholder:text-muted-foreground w-full rounded border px-2 py-1 text-sm"
								/>
							</div>
