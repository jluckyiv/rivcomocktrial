...
export type AttorneyTasksTaskTypeOptions =
	(typeof AttorneyTasksTaskTypeOptions)[keyof typeof AttorneyTasksTaskTypeOptions];
...
export type BallotScoresPresentationOptions =
	(typeof BallotScoresPresentationOptions)[keyof typeof BallotScoresPresentationOptions];

export const BallotScoresSideOptions = {
	prosecution: 'prosecution',
	defense: 'defense'
} as const;
export type BallotScoresSideOptions =
	(typeof BallotScoresSideOptions)[keyof typeof BallotScoresSideOptions];
...
export type BallotSubmissionsStatusOptions =
	(typeof BallotSubmissionsStatusOptions)[keyof typeof BallotSubmissionsStatusOptions];
...
export type CaseCharactersSideOptions =
	(typeof CaseCharactersSideOptions)[keyof typeof CaseCharactersSideOptions];
...
export type EligibilityChangeRequestsChangeTypeOptions =
	(typeof EligibilityChangeRequestsChangeTypeOptions)[keyof typeof EligibilityChangeRequestsChangeTypeOptions];
...
export type EligibilityChangeRequestsStatusOptions =
	(typeof EligibilityChangeRequestsStatusOptions)[keyof typeof EligibilityChangeRequestsStatusOptions];
...
export type EligibilityListEntriesStatusOptions =
	(typeof EligibilityListEntriesStatusOptions)[keyof typeof EligibilityListEntriesStatusOptions];
...
export type PresiderBallotsWinnerSideOptions =
	(typeof PresiderBallotsWinnerSideOptions)[keyof typeof PresiderBallotsWinnerSideOptions];

export const PresiderBallotsMotionRulingOptions = {
	granted: 'granted',
	denied: 'denied'
} as const;
export type PresiderBallotsMotionRulingOptions =
	(typeof PresiderBallotsMotionRulingOptions)[keyof typeof PresiderBallotsMotionRulingOptions];

export const PresiderBallotsVerdictOptions = {
	guilty: 'guilty',
	not_guilty: 'not_guilty'
} as const;
export type PresiderBallotsVerdictOptions =
	(typeof PresiderBallotsVerdictOptions)[keyof typeof PresiderBallotsVerdictOptions];
...
export type RegistrationsStatusOptions =
	(typeof RegistrationsStatusOptions)[keyof typeof RegistrationsStatusOptions];
...
export type RosterEntriesSideOptions =
	(typeof RosterEntriesSideOptions)[keyof typeof RosterEntriesSideOptions];
...
export type RosterEntriesEntryTypeOptions =
	(typeof RosterEntriesEntryTypeOptions)[keyof typeof RosterEntriesEntryTypeOptions];
...
export type RosterEntriesRoleOptions =
	(typeof RosterEntriesRoleOptions)[keyof typeof RosterEntriesRoleOptions];
...
export type RosterSubmissionsSideOptions =
	(typeof RosterSubmissionsSideOptions)[keyof typeof RosterSubmissionsSideOptions];
...
export type ScorerTokensScorerRoleOptions =
	(typeof ScorerTokensScorerRoleOptions)[keyof typeof ScorerTokensScorerRoleOptions];
...
export type ScorerTokensStatusOptions =
	(typeof ScorerTokensStatusOptions)[keyof typeof ScorerTokensStatusOptions];
...
export type TournamentsStatusOptions =
	(typeof TournamentsStatusOptions)[keyof typeof TournamentsStatusOptions];
...
export type WithdrawalRequestsStatusOptions =
	(typeof WithdrawalRequestsStatusOptions)[keyof typeof WithdrawalRequestsStatusOptions];
...
export type AttorneyCoachesResponse<Texpand = unknown> = Required<AttorneyCoachesRecord> &
	BaseSystemFields<Texpand>;
export type AttorneyTasksResponse<Texpand = unknown> = Required<AttorneyTasksRecord> &
	BaseSystemFields<Texpand>;
export type BallotCorrectionsResponse<Texpand = unknown> = Required<BallotCorrectionsRecord> &
	BaseSystemFields<Texpand>;
export type BallotScoresResponse<Texpand = unknown> = Required<BallotScoresRecord> &
	BaseSystemFields<Texpand>;
export type BallotSubmissionsResponse<Texpand = unknown> = Required<BallotSubmissionsRecord> &
	BaseSystemFields<Texpand>;
export type CaseCharactersResponse<Texpand = unknown> = Required<CaseCharactersRecord> &
	BaseSystemFields<Texpand>;
export type CoCoachesResponse<Texpand = unknown> = Required<CoCoachesRecord> &
	BaseSystemFields<Texpand>;
export type CourtroomsResponse<Texpand = unknown> = Required<CourtroomsRecord> &
	BaseSystemFields<Texpand>;
export type DistrictsResponse<Texpand = unknown> = Required<DistrictsRecord> &
	BaseSystemFields<Texpand>;
export type EligibilityChangeRequestsResponse<Texpand = unknown> =
	Required<EligibilityChangeRequestsRecord> & BaseSystemFields<Texpand>;
export type EligibilityListEntriesResponse<Texpand = unknown> =
	Required<EligibilityListEntriesRecord> & BaseSystemFields<Texpand>;
export type JudgesResponse<Texpand = unknown> = Required<JudgesRecord> & BaseSystemFields<Texpand>;
export type PresiderBallotsResponse<Texpand = unknown> = Required<PresiderBallotsRecord> &
	BaseSystemFields<Texpand>;
export type RegistrationsResponse<Texpand = unknown> = Required<RegistrationsRecord> &
	BaseSystemFields<Texpand>;
export type RosterEntriesResponse<Texpand = unknown> = Required<RosterEntriesRecord> &
	BaseSystemFields<Texpand>;
export type RosterSubmissionsResponse<Texpand = unknown> = Required<RosterSubmissionsRecord> &
	BaseSystemFields<Texpand>;
export type RoundsResponse<Texpand = unknown> = Required<RoundsRecord> & BaseSystemFields<Texpand>;
export type SchoolsResponse<Texpand = unknown> = Required<SchoolsRecord> &
	BaseSystemFields<Texpand>;
export type ScorerTokensResponse<Texpand = unknown> = Required<ScorerTokensRecord> &
	BaseSystemFields<Texpand>;
export type StudentsResponse<Texpand = unknown> = Required<StudentsRecord> &
	BaseSystemFields<Texpand>;
export type TeamsResponse<Texpand = unknown> = Required<TeamsRecord> & BaseSystemFields<Texpand>;
export type TournamentsResponse<Texpand = unknown> = Required<TournamentsRecord> &
	BaseSystemFields<Texpand>;
export type TrialsResponse<Texpand = unknown> = Required<TrialsRecord> & BaseSystemFields<Texpand>;
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> & AuthSystemFields<Texpand>;
export type WithdrawalRequestsResponse<Texpand = unknown> = Required<WithdrawalRequestsRecord> &
	BaseSystemFields<Texpand>;
