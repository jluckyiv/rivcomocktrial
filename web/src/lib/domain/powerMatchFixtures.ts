...
export const allTeams: Team[] = [
	team01, team02, team03, team04, team05, team06, team08, team09,
	team10, team11, team12, team13, team14, team15, team16, team17,
	team19, team20, team21, team22, team23, team24, team25, team26,
	team27, team28,
]
...
const round1Records: MatchRecord<Team>[] = [
	r(team06, team15), r(team24, team01), r(team19, team09), r(team08, team11),
	r(team05, team27), r(team26, team13), r(team10, team02), r(team03, team16),
	r(team04, team14), r(team28, team25), r(team22, team17), r(team21, team12),
	r(team23, team20),
]

const round2Records: MatchRecord<Team>[] = [
	r(team09, team23), r(team02, team19), r(team27, team21), r(team16, team22),
	r(team13, team04), r(team12, team06), r(team25, team03), r(team15, team05),
	r(team11, team24), r(team20, team26), r(team14, team28), r(team17, team10),
	r(team01, team08),
]

const round3Records: MatchRecord<Team>[] = [
	r(team25, team01), r(team28, team05), r(team23, team17), r(team20, team12),
	r(team06, team03), r(team04, team02), r(team26, team14), r(team10, team08),
	r(team19, team16), r(team22, team09), r(team21, team24), r(team15, team11),
	r(team27, team13),
]

const round4Records: MatchRecord<Team>[] = [
	r(team02, team15), r(team16, team25), r(team13, team21), r(team24, team26),
	r(team12, team22), r(team11, team28), r(team05, team10), r(team01, team27),
	r(team03, team23), r(team08, team04), r(team14, team06), r(team17, team19),
	r(team09, team20),
]
